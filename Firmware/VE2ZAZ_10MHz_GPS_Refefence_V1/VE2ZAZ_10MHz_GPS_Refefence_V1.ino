/*
 ...
 ( )( )(  _)(__ \(_  ) (  ) (_  )   / ) ( )( )(  ) (__ \(  )( \/\/ )
  ...
  VE2ZAZ/VA2IW, V1, March 2024. https://ve2zaz.net
...
{
  SPI.beginTransaction(SPISettings(1000000, MSBFIRST, SPI_MODE0)); // Start of writing to one of the DACs via the SPI port (rate, bit order, SPI bus mode)
...
//  save_params_eeprom();
  ...
  SPI.beginTransaction(SPISettings(1000000, MSBFIRST, SPI_MODE0));// Start of a DAC write via the SPI port (rate, bit order, SPI bus mode)
  digitalWrite(PIN_SPI_SS, LOW);                                  // Lowering the DAC’s Slave Select signal
